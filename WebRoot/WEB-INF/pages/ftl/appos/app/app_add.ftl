...
<body>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table-form">
  	...
  	<tr>
  		...
  		<td><input type="text" id="wx_appid" name="wx_appid" class="text"/></td>
  	</tr>
  	<tr>
  		<td class="showTitle">微信parternerKey：</td>
  		<td><input type="text" id="wx_parternerKey" name="wx_parternerKey" class="text"/></td>
  	</tr>
  	<tr>
  		<td class="showTitle">微信商户号：</td>
  		<td><input type="text" id="wx_mch_id" name="wx_mch_id" class="text"/></td>
  	</tr>
  	<tr>
  		<td class="showTitle">通知地址：</td>
  		<td><input type="text" id="notify_url" name="notify_url" class="text"/></td>
  	</tr>
  </table>
