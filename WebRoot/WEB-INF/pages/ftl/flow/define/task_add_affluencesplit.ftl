...
<#if (isEdit)>
<form action="${ctx}/permit/flow/design/edit_split_affluence.do" method="post" id="form" target="_self">
...
<#else>
<form action="${ctx}/permit/flow/design/save_split_affluence.do" method="post" id="form" target="_self">
