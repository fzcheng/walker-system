...
<#if (isEdit)>
<form action="${ctx}/permit/flow/design/edit_single.do" method="post" id="form" target="_self">
...
<#else>
<form action="${ctx}/permit/flow/design/save_single.do" method="post" id="form" target="_self">
