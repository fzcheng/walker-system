...
<table border="0" cellpadding="0" cellspacing="0" class="table-form">
	<tr class="title">
		<td>
			<span>授权文件管理</span>&nbsp;|&nbsp;
			<input type="button" value="创建授权" onclick="showAdd();" class="button-tj"/>&nbsp;
			<input type="button" value="删除" onclick="remove();" class="button"/>&nbsp;
		</td>
	</tr>
</table>
<div id="pageInfo">
	<#include "/deploy/accredit/accredit_list.ftl">
</div>
