				...
				$.ajax({
					...
					success:function(msg){
						if(msg == "0"){
							...
							parent.frames.sampleframe.reload(0);
...
<body>
  <table border="0" cellpadding="0" cellspacing="0" class="table-form">
  	<tr>
  		<td width="120px" class="showTitle">角色名称：(<span class="required">*</span>)</td>
  		<td><input type="text" id="roleName" name="roleName" style="width:260px;" class="text"/></td>
  	</tr>
  	<tr>
  		<td valign="top" class="showTitle">角色描述：</td>
