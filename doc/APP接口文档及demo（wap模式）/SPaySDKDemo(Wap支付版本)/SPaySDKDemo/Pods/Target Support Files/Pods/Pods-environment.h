...
// XMLReader-Arc
#define COCOAPODS_POD_AVAILABLE_XMLReader_Arc
#define COCOAPODS_VERSION_MAJOR_XMLReader_Arc 1
#define COCOAPODS_VERSION_MINOR_XMLReader_Arc 1
#define COCOAPODS_VERSION_PATCH_XMLReader_Arc 0
