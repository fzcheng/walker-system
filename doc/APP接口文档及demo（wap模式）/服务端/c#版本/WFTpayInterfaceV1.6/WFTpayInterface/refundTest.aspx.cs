...
{
    public partial class refundTest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.tbout_refund_no.Text = Utils.Nmrandom();//商户退款单号 
            }
        }
        ...
        protected void btnok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.reqHandler.setParameter("refund_fee",tbrefund_fee.Text  );//退款金额
                this.reqHandler.setParameter("refund_channel", Drrefund_channel.SelectedValue);//退款渠道
                ...
                this.reqHandler.setParameter("op_user_id", this.cfg["mch_id"]);//必填项，操作员帐号,默认为商户号
