<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="queryRefund.aspx.cs" Inherits="WFTpayInterface.queryRefund" %>
            ...
            <div id="auto_center">
                ...
                <div class="nrmain">
                    ...
                    <div class="filedkd">商户退款单号&nbsp;&nbsp;&nbsp; ：<asp:TextBox ID="tbout_refund_no" runat="server" Width="267px" Height="26px" ToolTip="长度32"></asp:TextBox>
                        <asp:Label ID="Label2" runat="server" Text="*长度32"></asp:Label>
                    </div>
                    <div class="filedkd">威富通退款单号 ：<asp:TextBox ID="tbrefund_id" runat="server" Width="267px" Height="26px" ToolTip="长度32"></asp:TextBox>
                        <asp:Label ID="Label5" runat="server" Text="*长度32"></asp:Label>
                      </div>
