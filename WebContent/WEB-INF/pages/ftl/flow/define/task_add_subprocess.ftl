...
<#if (isEdit)>
<form action="${ctx}/permit/flow/design/edit_subprocess.do" method="post" id="form" target="_self">
...
<#else>
<form action="${ctx}/permit/flow/design/save_subprocess.do" method="post" id="form" target="_self">
...
<#include "/flow/define/inc_task_subprocess_edit.ftl">
...
<#include "/flow/define/inc_task_subprocess.ftl">
